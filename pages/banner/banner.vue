<template>
	<view>
		...
		<view class="article-meta">
			<text class="article-author">人民日报</text>
			<text class="article-text">发表于</text>
			<text class="article-time">2021-02-03 13:42:45 </text>
		</view>
		<view class="article-content">
			<h2>场景再现</h2>
			<text>2018年11月6日上午，上海市虹口区市民驿站嘉兴路街道第一分站，十几位社区青年志愿者如约而至。这里是近两年他们每个月“碰头”的地方，切磋学习、资源共享，他们会将社区治理难题拿到这里议一议。
			...
			<image class="banner-img" src="../../static/banner2.jpg" mode="aspectFit"></image>
			<text>
			...
			<h2>系统观念</h2>
			<h2>“关键是要加强科学管理、形成长效机制、推动习惯养成”</h2>
			<text>
